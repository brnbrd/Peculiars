...
public class PeculiarsItems {
    ...
    public static final RegistryObject<Item> YUCCA_ICE_CREAM = HELPER.createItem("yucca_ice_cream", () -> new IceCreamItem(new Item.Properties().food(Foods.YUCCA_ICE_CREAM).craftRemainder(Items.BOWL).stacksTo(1)));
    public static final RegistryObject<Item> YUCCA_MILKSHAKE = HELPER.createItem("yucca_milkshake", () -> new MilkshakeItem(new Item.Properties().food(Foods.YUCCA_MILKSHAKE).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
    public static final RegistryObject<Item> YUCCA_FUDGE = HELPER.createItem("yucca_fudge", () -> new Item(new Item.Properties().food(Foods.YUCCA_FUDGE)));
    public static final RegistryObject<Item> YUCCA_CAKE = HELPER.createItem("yucca_cake", () -> new BlockItem(PeculiarsBlocks.YUCCA_CAKE_BLOCK.get(), new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> ALOE_ICE_CREAM = HELPER.createItem("aloe_ice_cream", () -> new IceCreamItem(new Item.Properties().food(Foods.ALOE_ICE_CREAM).craftRemainder(Items.BOWL).stacksTo(1)));
    public static final RegistryObject<Item> ALOE_MILKSHAKE = HELPER.createItem("aloe_milkshake", () -> new MilkshakeItem(new Item.Properties().food(Foods.ALOE_MILKSHAKE).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
    public static final RegistryObject<Item> ALOE_JELLY_SLICE = HELPER.createItem("aloe_jelly_slice", () -> new Item(new Item.Properties().food(Foods.ALOE_JELLY_SLICE)));
